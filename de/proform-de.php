...
<?php
    ...
    {
    if($cb1 == 'checkbox1'){
        header("Location: https://jdisc.eu/newsletter/de/probackend-newsletter-de.php?fname=$fname&lname=$lname&from=$from&tel=$tel&comp=$comp", true, 301);
    }else if ($cb2 == 'checkbox2'){
        header("Location: https://jdisc.eu/newsletter/de/probackend-newsletter-de.php?fname=$fname&lname=$lname&from=$from&tel=$tel&comp=$comp", true, 301);
    }else if ($cb1 == 'checkbox1' && $cb2 == 'checkbox2'){
        header("Location: https://jdisc.eu/newsletter/de/probackend-newsletter-de.php?fname=$fname&lname=$lname&from=$from&tel=$tel&comp=$comp", true, 301);
    }else{
        header("Location: https://jdisc.eu/newsletter/de/probackend-download-de.php?fname=$fname&lname=$lname&from=$from&tel=$tel&comp=$comp", true, 301);
        }
    }
?>
<!DOCTYPE html>
