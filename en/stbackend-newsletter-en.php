...
<?php
    ...
    $subject = "Ein Kunde hat sich für die Standard ionelle Version entschieden";
    $message = "
    <html>
        <head>
    ...
    {
        header("Location: https://jdisc.eu/newsletter/en/newsletter-en.php?fname=$fname&lname=$lname&from=$from", true, 301);
    ...
    $messagecustomer = file_get_contents('https://jdisc.eu/newsletter/en/stcustomermail-en.php');
    /////////////// MAIL TO EMPLOYEE///////////////////////////////////
    // Always set content-type when sending HTML email
